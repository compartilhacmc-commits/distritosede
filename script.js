...
// NOVOS LINKS DO DISTRITO SEDE
// ===================================
const SHEET_ID = '1fn02Xx2bMOswFden8FrwhqjJ4zZ2mAAvnq61IRa9_Mg';
...
const SHEETS = [
  ...
  },
  {
    ...
    url: gvizCsvUrl(SHEET_ID, '120192244'),
    distrito: 'SEDE',
    tipo: 'RESOLVIDO'
  }
];
...
function downloadExcel() {
  ...
  XLSX.writeFile(wb, `Dados_Sede_${hoje}.xlsx`);
}
